...
import sdis.brokermsg.tcp.common.*;
                ...
                switch (me.getPrimitiva()) {
                    ...
                    case STATE:
                        if(authored && userlogged.equals("admin")){
                            ms = new MensajeProtocolo(Primitiva.STATE, "Hilos maximos: " + ServidorTCP.NThreads + " Hilos ocupados: " + ServidorTCP.ClientesUsados + " Mensajes enviados: " + ServidorTCP.pushed + " Mensajes recibidos: " + ServidorTCP.pulled);
                            oos.writeObject(ms);
                        }else{
